...
<script lang="ts">
  ...
  const timeline = [
    ...
    },
    {
      ...
      description: 'Completed an intensive fullstack development bootcamp, sharpening backend systems and API design.',
      type: 'education'
    },
    {
      year: '2023',
      title: 'Self-taught Journey Begins',
      description: 'Started learning programming independently — fell in love with building backend systems.',
      type: 'education'
    },
  ]
